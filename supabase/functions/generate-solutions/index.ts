...
- В блоке «то это приведёт к …» — название и направление опережающей (leading) метрики (например: «росту доли активаций на 7-й день», «снижению времени до первой ценности»).
